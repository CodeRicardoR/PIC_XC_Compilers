...
void ReadByteSW_USART(void){
    ...
    RxBuffer = 0;
    while(PORTBbits.RB0);
    _delay((unsigned long)((15)*(9830400UL/4000000.0)));
    ...
    _delay((unsigned long)((14)*(9830400UL/4000000.0)));
    return;
}
