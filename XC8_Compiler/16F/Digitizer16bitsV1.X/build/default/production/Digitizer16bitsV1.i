        ...
        switch(CmdGPS){
            case 0:
                if(ControlSample == 1){
                    ...
                    Data_X = (signed short) (SumData_X/10);
                    Data_Y = (signed short) (SumData_Y/10);
                    Data_Z = (signed short) (SumData_Z/10);
                    Data_TC = (signed short) (SumData_TC/10);
                    Data_TS = (signed short) (SumData_TS/10);
