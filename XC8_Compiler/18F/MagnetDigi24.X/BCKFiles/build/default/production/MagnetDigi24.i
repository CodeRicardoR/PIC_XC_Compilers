    ...
    if((PIE1bits.RC1IE == 1) && (PIR1bits.RC1IF == 1)){
        ...
        switch(ID){
            ...
            case '6':
                ...
                PORTB = 0x0C;
                _delay((unsigned long)((7)*(39321600UL/4000.0)));
                SumData_GND = 0;
                TransferByte_SPI(0x80);
                ReadAD24(0,0x00);
                for(conta=0; conta<5; conta++){
                    TransferByte_SPI(0x80);
                    Data_GND = ReadAD24(1,0x00);
                    SumData_GND = SumData_GND + Data_GND;
                }
                Data_GND = SumData_GND/5;
            ...
            case '9':
                ...
                Data_Y = SumData_Y/5;
                Data_Z = SumData_Z/5;
                Data_TC = SumData_TC/5;
                Data_TS = SumData_TS/5;
                Data_AUX0 = SumData_AUX0/5;
                Data_AUX1 = SumData_AUX1/5;
                Data_AUX2 = SumData_AUX2/5;
...
void main(void) {
    ...
    TRISB = 0x01;
    TRISC = 0x00;
    _delay((unsigned long)((100)*(39321600UL/4000.0)));
