...
unsigned long ReadAD24(unsigned char flag_convert, unsigned char cmd_convert);
...
unsigned char ResetCS5532(void){
    ...
    _delay((unsigned long)((2)*(39321600UL/4000.0)));

    ReadRegister_4bytesCS5532(0x0B);
    BufferSPI[0] |= 0x20;
    WriteRegister_4bytesCS5532(0x03);
    _delay((unsigned long)((25)*(39321600UL/4000000.0)));
    BufferSPI[0] &= 0xDF;
    WriteRegister_4bytesCS5532(0x03);
    _delay((unsigned long)((25)*(39321600UL/4000000.0)));
    ReadRegister_4bytesCS5532(0x0B);
...
void InitCS5532(void){
    ...
    BufferSPI[2] = 0x05;
    BufferSPI[3] = 0x00;
    WriteRegister_4bytesCS5532(0x05);
    return;
}
...
void ReadRegister_4bytesCS5532(unsigned char command){
    ...
    BufferSPI[3] = TransferByte_SPI(0x00);
    return;
}
...
void WriteRegister_4bytesCS5532(unsigned char command){
    ...
    TransferByte_SPI(command);
    TransferByte_SPI(BufferSPI[0]);
    TransferByte_SPI(BufferSPI[1]);
    TransferByte_SPI(BufferSPI[2]);
    TransferByte_SPI(BufferSPI[3]);
...
unsigned long ReadAD24(unsigned char flag_convert, unsigned char cmd_convert){
    unsigned long DataADC;
    unsigned char ByteUpper, ByteHigh, ByteLow;

    while(PORTCbits.RC4);
    ReadRegister_4bytesCS5532(cmd_convert);
    ByteUpper = BufferSPI[0];
    ByteHigh = BufferSPI[1];
    ByteLow = BufferSPI[2];

    DataADC = 0;
    if(flag_convert){
        DataADC = DataADC | (unsigned long)ByteUpper<<16;
        DataADC = DataADC | (unsigned long)ByteHigh<<8;
        DataADC = DataADC | (unsigned long)ByteLow;
    }
...
void CleanHolding(void){
    ...
    PORTB = 0X0C;
    _delay((unsigned long)((100)*(39321600UL/4000000.0)));
    ReadAD24(0, 0x00);
    return;
}
