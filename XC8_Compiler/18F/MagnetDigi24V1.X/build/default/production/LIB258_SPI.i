...
unsigned char ResetCS5532(void){
    ...
    _delay((unsigned long)((2)*(9830400UL/4000.0)));

    ReadRegister_4bytesCS5532(0x0B);
    BufferSPI[0] |= 0x20;
    WriteRegister_4bytesCS5532(0x03);
    _delay((unsigned long)((25)*(9830400UL/4000000.0)));
    BufferSPI[0] &= 0xDF;
    WriteRegister_4bytesCS5532(0x03);
    _delay((unsigned long)((25)*(9830400UL/4000000.0)));
    ReadRegister_4bytesCS5532(0x0B);
...
signed long ReadAD24(unsigned char flag_convert, unsigned char cmd_convert){
    ...
    DataADC = 0;
    if(flag_convert){
        DataADC = DataADC | (signed long) BufferSPI[0]<<24;
        DataADC = DataADC | (signed long) BufferSPI[1]<<16;
        DataADC = DataADC | (signed long) BufferSPI[2]<<8;
        DataADC = DataADC | (signed long) 0x00<<0;
        DataADC = DataADC/256;
    }
...
void CleanHolding(void){
    ...
    PORTB = 0X0C;
    _delay((unsigned long)((100)*(9830400UL/4000000.0)));
    ReadAD24(0, 0x00);
    return;
}
