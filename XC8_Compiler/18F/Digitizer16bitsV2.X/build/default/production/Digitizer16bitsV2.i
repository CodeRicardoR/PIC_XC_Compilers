...
# 2 "<built-in>" 2
# 1 "Digitizer16bitsV2.c" 2
# 11 "Digitizer16bitsV2.c"
# 1 "./main.h" 1
# 12 "./main.h"
        ...
        switch(CmdGPS){
            case 0:
                if(ControlSample == 1){
                    ...
                    LATB = 0x2E;
                    LATBbits.LB7 = 1;
                    _delay((unsigned long)((8)*(39321600UL/4000.0)));
                    ...
                    Data_X = (signed short) (SumData_X/50);
                    Data_Y = (signed short) (SumData_Y/50);
                    Data_Z = (signed short) (SumData_Z/50);
                    Data_TC = (signed short) (SumData_TC/50);
                    Data_TS = (signed short) (SumData_TS/50);
                    Data_AUX0 = (signed short) (SumData_AUX0/50);
                    Data_AUX1 = (signed short) (SumData_AUX1/50);
                    Data_AUX2 = (signed short) (SumData_AUX2/50);
