...
char DateTimeGPS[13] = "XXXXXXXXXXXX";
...
void __attribute__((picinterrupt(("")))) Interrups(void){
    ...
    if((PIE1bits.TMR1IE == 1) && (PIR1bits.TMR1IF == 1)){
        ...
        BufferDAT[1] = TMR0H;
        TransmitDAT_USART('8');
        _delay((unsigned long)((500)*(39321600UL/4000.0)));
    ...
    while(1){
        ...
        switch(ID){
            case '0':
                ...
                ResetAD7177();
                WriteRegister_2bytesAD7177(0x01, 0x00, 0x2C);
                _delay((unsigned long)((5)*(39321600UL/4000.0)));
                WriteRegister_2bytesAD7177(0x20, 0x1F, 0x00);
                _delay((unsigned long)((5)*(39321600UL/4000.0)));
                WriteRegister_2bytesAD7177(0x02, 0x00, 0x02);
            ...
            case '4':
                ...
                LATCbits.LATC2 = 0;
                TransferByte_SPI(0x01);
                TransferByte_SPI(0x00);
                TransferByte_SPI(0x1C);
